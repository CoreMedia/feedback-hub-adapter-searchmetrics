    ...
    super((()=> ConfigUtils.apply(Config(KeywordScoreBar, {
      ...
      items: [
        Config(IconDisplayField, {
          iconCls: CoreIcons_properties.approve,
        ...
        Config(IconDisplayField, {
          ...
          plugins: [
            Config(BindPropertyPlugin, {
              ...
              bindTo: config.bindTo.extendBy(config.labelPropertyName),
            }),
          ],
        }),
        Config(DisplayField, {
          itemId: this.BAR_ITEM_ID,
          html: true,
          width: 150,
        }),
        Config(Container, {
          ...
          items: [
            Config(DisplayField, {
              ...
              plugins: [
                Config(BindPropertyPlugin, {
                  componentProperty: "value",
                  bindTo: config.bindTo.extendBy(config.valuePropertyName),
