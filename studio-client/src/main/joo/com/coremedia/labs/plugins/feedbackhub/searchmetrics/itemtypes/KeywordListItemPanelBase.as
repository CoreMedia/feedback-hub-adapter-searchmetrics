...
import com.coremedia.labs.plugins.feedbackhub.searchmetrics.model.KeywordScore;
...
public class KeywordListItemPanelBase extends FeedbackItemPanel {
  ...
  protected function getButtonLabel(config:KeywordListItemPanel):String {
    var label:String = resourceManager.getString('com.coremedia.labs.plugins.feedbackhub.searchmetrics.FeedbackHubSearchmetrics', 'searchmetrics_load_more');
